...
// openFile:OpenFile(int sector, int m_type)
// open a Nachos file for reading and writing. Bring the file header into memory while the file is open.
// "sector" -- the location on disk off the header for this file
// "m_type" -- the type you want to open file
OpenFile::OpenFile(int sector, int m_type)
{
    hdr = new FileHeader;
    hdr->FetchFrom(sector);
